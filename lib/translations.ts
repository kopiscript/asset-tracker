export const t = {
  en: {
    ...
    durationMin: "min",
    distanceKm: "km",
    errorMaxWindow: "Maximum history window is 365 days.",
    ...
    activityTrend: "24-Hour Activity",
    avgSpeed: "Avg Speed",
    ...
    allClearDesc: "No battery, fuel, or engine issues detected across the fleet right now.",
    ofFleet: "of fleet",
    peakLabel: "Peak",
    nowLabel: "Now",
    movingVehiclesUnit: "vehicles",
    currentlyMoving: "Currently Moving",
    noneMovingRightNow: "Nothing is moving right now.",
    reasonBattery: "Weak car battery",
    reasonFuel: "Low fuel",
    reasonCoolant: "Engine running hot",

    // Billing page
    billingSubtitle: "Manage your subscription for {name}",
    paymentOverdue: "Payment overdue",
    gracePeriodEnds: "Grace period ends {date}. Dashboard will be locked after that date.",
    currentPlanLabel: "Current plan",
    perMonth: "/ month",
    planExpired: "Expired",
    planActive: "Active",
    statPingRate: "Ping rate",
    perMin: "1 / min",
    per10Sec: "1 / 10 sec",
    renewsOn: "Renews {date}",
    ownerOnlyBilling: "Only the org owner can manage billing.",
    upgradeTo: "Upgrade to {plan}",
    contactUpgrade: "Contact us to upgrade",
    renewPlan: "Renew {plan}",
    billingEnquiry: "Billing enquiry",
    noOrgFound: "No organisation found on your account.",

    // Vehicle form
    addVehicleSubtitle: "Register a new GPS device to your fleet.",
    fieldImei: "IMEI *",
    imeiHint: "Unique device identifier from the GPS hardware",
    fieldVehicleName: "Vehicle Name *",
    fieldPlateNumber: "Plate Number *",
    fieldVehicleType: "Vehicle Type *",
    fieldDriverName: "Driver Name",
    fieldSpeedLimit: "Speed Limit (km/h)",
    speedLimitHint: "Vehicles reporting above this speed are flagged as overspeeding",
    selectTypePlaceholder: "Select type",
    saving: "Saving…",
    saveChanges: "Save Changes",
    errImeiRequired: "IMEI is required.",
    errNameRequired: "Vehicle name is required.",
    errPlateRequired: "Plate number is required.",
    errTypeRequired: "Vehicle type is required.",
    errCreateVehicle: "Failed to create vehicle.",
    errUpdateVehicle: "Failed to update vehicle.",
    edit: "Edit",
    ...
    roleEditorDesc: "Can view + edit details",
    roleOwnerDesc: "Full control",
    inviteGrantedMsg: "{email} has been granted {role} access.",
    errInviteUser: "Failed to invite user.",

    // Safety tab (MIROS TrackScore)
    safetyTab: "Safety",
    panicButtonTitle: "Emergency",
    panicButtonDesc: "Alert your fleet manager immediately if this vehicle needs urgent help.",
    reportEmergency: "Report Emergency",
    confirmEmergency: "Are you sure?",
    yesReport: "Yes, report",
    emergencyReported: "Emergency reported",
    geofencesTitle: "Geofences",
    addGeofence: "Add Geofence",
    geofenceCenteredHint: "Centered on this vehicle's current position.",
    geofenceNamePlaceholder: "e.g. Depot, Warehouse",
    meters: "m",
    noGeofences: "No geofences set up for this vehicle yet.",
    eventsTitle: "Recent Safety Events",
    speedLimitBadge: "Limit",
    noEvents: "No safety events recorded yet.",
    errNoPositionYet: "This vehicle has no GPS position yet.",
    errCreateGeofence: "Failed to create geofence.",
    eventOverspeed: "Overspeed",
    eventHarshBrake: "Harsh braking",
    eventHarshAccel: "Harsh acceleration",
    eventGeofenceEnter: "Entered geofence",
    eventGeofenceExit: "Exited geofence",
    eventEmergency: "Emergency reported",

    // Misc empty / auth states
    pleaseSignIn: "Please sign in.",
    total: "total",
    noOrgsYet: "No organisations yet",
    noOrgsDesc: "Create an organisation to group your fleet and invite your team.",
    createFirstOrg: "Create your first org",

    // Engine / OBD tab
    engineTab: "Engine",
    engineAndFuel: "Engine & Fuel",
    fuelLevelLabel: "Fuel Level",
    coolantTempLabel: "Coolant Temp",
    engineRpmLabel: "Engine RPM",
    engineLoadLabel: "Engine Load",
    moreEngineDetails: "More engine details",
    throttleLabel: "Throttle",
    absoluteLoadLabel: "Absolute Load",
    moduleVoltageLabel: "Module Voltage",
    intakeAirLabel: "Intake Air Temp",
    mafLabel: "Air Flow (MAF)",
    barometricLabel: "Barometric Pressure",
    noEngineData: "No engine data",
    noEngineDataDesc: "This tracker isn't reading the vehicle's OBD port, so engine and fuel telemetry aren't available.",
    fuelOk: "OK",
    fuelLow: "Low fuel",
    fuelCritical: "Refuel now",
    coolantWarming: "Warming up",
    coolantNormal: "Normal",
    coolantHot: "Running hot",
    coolantCritical: "Overheating",
  ...
  bm: {
    ...
    durationMin: "min",
    distanceKm: "km",
    errorMaxWindow: "Tetingkap sejarah maksimum ialah 365 hari.",
    ...
    // Dashboard analytics
    fleetComposition: "Komposisi Fleet",
    activityTrend: "Aktiviti 24 Jam",
    avgSpeed: "Kelajuan Purata",
    movingNow: "sedang bergerak",
    batteryHealth: "Kesihatan Bateri",
    fuelLevels: "Tahap Bahan Api",
    attentionNeeded: "Perlu Perhatian",
    allClear: "Semua sistem normal",
    allClearDesc: "Tiada isu bateri, bahan api, atau enjin dikesan pada fleet buat masa ini.",
    ofFleet: "daripada fleet",
    peakLabel: "Kemuncak",
    nowLabel: "Sekarang",
    movingVehiclesUnit: "kenderaan",
    currentlyMoving: "Sedang Bergerak",
    noneMovingRightNow: "Tiada kenderaan bergerak buat masa ini.",
    reasonBattery: "Bateri kereta lemah",
    reasonFuel: "Bahan api rendah",
    reasonCoolant: "Enjin terlalu panas",

    // Billing page
    billingSubtitle: "Urus langganan untuk {name}",
    paymentOverdue: "Bayaran tertunggak",
    gracePeriodEnds: "Tempoh tangguh tamat {date}. Papan pemuka akan dikunci selepas tarikh itu.",
    currentPlanLabel: "Pelan semasa",
    perMonth: "/ bulan",
    planExpired: "Tamat tempoh",
    planActive: "Aktif",
    statPingRate: "Kadar Ping",
    perMin: "1 / min",
    per10Sec: "1 / 10 saat",
    renewsOn: "Diperbaharui {date}",
    ownerOnlyBilling: "Hanya pemilik organisasi boleh mengurus pengebilan.",
    upgradeTo: "Naik taraf ke {plan}",
    contactUpgrade: "Hubungi kami untuk naik taraf",
    renewPlan: "Perbaharui {plan}",
    billingEnquiry: "Pertanyaan pengebilan",
    noOrgFound: "Tiada organisasi dijumpai pada akaun anda.",

    // Vehicle form
    addVehicleSubtitle: "Daftarkan peranti GPS baharu ke armada anda.",
    fieldImei: "IMEI *",
    imeiHint: "Pengecam peranti unik daripada perkakasan GPS",
    fieldVehicleName: "Nama Kenderaan *",
    fieldPlateNumber: "No. Plat *",
    fieldVehicleType: "Jenis Kenderaan *",
    fieldDriverName: "Nama Pemandu",
    fieldSpeedLimit: "Had Laju (km/j)",
    speedLimitHint: "Kenderaan yang melaporkan kelajuan melebihi ini akan ditanda sebagai memandu laju",
    selectTypePlaceholder: "Pilih jenis",
    saving: "Menyimpan…",
    saveChanges: "Simpan Perubahan",
    errImeiRequired: "IMEI diperlukan.",
    errNameRequired: "Nama kenderaan diperlukan.",
    errPlateRequired: "No. plat diperlukan.",
    errTypeRequired: "Jenis kenderaan diperlukan.",
    errCreateVehicle: "Gagal mencipta kenderaan.",
    errUpdateVehicle: "Gagal mengemas kini kenderaan.",
    edit: "Edit",
    errNetwork: "Ralat rangkaian. Sila cuba lagi.",
    errLoadHistory: "Gagal memuatkan sejarah.",

    // Share page
    inviteSomeone: "Jemput Seseorang",
    enterEmailPlaceholder: "Masukkan alamat e-mel…",
    inviting: "Menjemput…",
    roleViewerDesc: "Hanya boleh lihat",
    roleEditorDesc: "Boleh lihat + edit butiran",
    roleOwnerDesc: "Kawalan penuh",
    inviteGrantedMsg: "{email} telah diberikan akses {role}.",
    errInviteUser: "Gagal menjemput pengguna.",

    // Safety tab (MIROS TrackScore)
    safetyTab: "Keselamatan",
    panicButtonTitle: "Kecemasan",
    panicButtonDesc: "Beritahu pengurus armada anda dengan segera jika kenderaan ini memerlukan bantuan kecemasan.",
    reportEmergency: "Lapor Kecemasan",
    confirmEmergency: "Adakah anda pasti?",
    yesReport: "Ya, lapor",
    emergencyReported: "Kecemasan dilaporkan",
    geofencesTitle: "Geopagar",
    addGeofence: "Tambah Geopagar",
    geofenceCenteredHint: "Dipusatkan pada kedudukan semasa kenderaan ini.",
    geofenceNamePlaceholder: "cth. Depoh, Gudang",
    meters: "m",
    noGeofences: "Tiada geopagar disediakan untuk kenderaan ini lagi.",
    eventsTitle: "Kejadian Keselamatan Terkini",
    speedLimitBadge: "Had",
    noEvents: "Tiada kejadian keselamatan direkodkan lagi.",
    errNoPositionYet: "Kenderaan ini belum mempunyai kedudukan GPS.",
    errCreateGeofence: "Gagal mencipta geopagar.",
    eventOverspeed: "Memandu laju",
    eventHarshBrake: "Brek mengejut",
    eventHarshAccel: "Pecutan mengejut",
    eventGeofenceEnter: "Memasuki geopagar",
    eventGeofenceExit: "Meninggalkan geopagar",
    eventEmergency: "Kecemasan dilaporkan",

    // Misc empty / auth states
    pleaseSignIn: "Sila log masuk.",
    total: "jumlah",
    noOrgsYet: "Tiada organisasi lagi",
    noOrgsDesc: "Cipta organisasi untuk mengumpulkan armada anda dan menjemput pasukan anda.",
    createFirstOrg: "Cipta org pertama anda",

    // Engine / OBD tab
    engineTab: "Enjin",
    engineAndFuel: "Enjin & Bahan Api",
    fuelLevelLabel: "Tahap Bahan Api",
    coolantTempLabel: "Suhu Penyejuk",
    engineRpmLabel: "RPM Enjin",
    engineLoadLabel: "Beban Enjin",
    moreEngineDetails: "Butiran enjin lanjut",
    throttleLabel: "Pendikit",
    absoluteLoadLabel: "Beban Mutlak",
    moduleVoltageLabel: "Voltan Modul",
    intakeAirLabel: "Suhu Udara Masuk",
    mafLabel: "Aliran Udara (MAF)",
    barometricLabel: "Tekanan Barometrik",
    noEngineData: "Tiada data enjin",
    noEngineDataDesc: "Penjejak ini tidak membaca port OBD kenderaan, jadi telemetri enjin dan bahan api tidak tersedia.",
    fuelOk: "OK",
    fuelLow: "Bahan api rendah",
    fuelCritical: "Isi minyak sekarang",
    coolantWarming: "Memanaskan",
    coolantNormal: "Normal",
    coolantHot: "Suhu tinggi",
    coolantCritical: "Terlampau panas",
